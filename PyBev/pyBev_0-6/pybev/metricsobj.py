...
class MCAPData:
    ...
    Methods:
        ...
        .fpivot_status(status): filters data on Vehicle_Status and pivots
    """
...
class PanelMetrics:
    ...
    Attributes:
        ...
        volatile_column: the column header on the spreadsheet, default 'MCAP Data'
...
class FlashMetrics:
    """A Flash Metrics object. Flash uses days rather than weekdates, and the
    metrics document is structured slightly differently as a result."""
