...
def stage_one():
    ...
    stripped_date = dc.date_stripper(dtt.datetime.today() - dtt.timedelta(days=1))
...
def new_week_column(metrics):
    ...
    if stripped_date not in metrics.df.columns:
        ...
        sunday_date = EST.localize(stripped_date) - dtt.timedelta(hours=4)
